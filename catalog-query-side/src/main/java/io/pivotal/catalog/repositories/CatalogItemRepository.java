...
import io.pivotal.catalog.entities.CatalogItem;
...
@RepositoryRestResource(path = "catalogitems")
public interface CatalogItemRepository extends CrudRepository<CatalogItem, String> {
    ...
    <S extends CatalogItem> S save(S entity);
    ...
    void delete(CatalogItem entity);
