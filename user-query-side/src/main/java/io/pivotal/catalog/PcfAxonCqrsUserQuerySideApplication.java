...
public class PcfAxonCqrsUserQuerySideApplication {

    private static final Logger LOG = LoggerFactory.getLogger(PcfAxonCqrsUserQuerySideApplication.class);
    ...
    */
    ...
    public static void main(String[] args) {
        SpringApplication.run(PcfAxonCqrsUserQuerySideApplication.class, args);
