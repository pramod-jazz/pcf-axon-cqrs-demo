...
public class PcfAxonCqrsCatalogQuerySideApplication {

    private static final Logger LOG = LoggerFactory.getLogger(PcfAxonCqrsCatalogQuerySideApplication.class);
    ...
    */
    ...
    public static void main(String[] args) {
        SpringApplication.run(PcfAxonCqrsCatalogQuerySideApplication.class, args);
